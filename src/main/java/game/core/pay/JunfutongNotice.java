...
public class JunfutongNotice {
    ...
    public String getP13_zfmoney() {
        return p13_zfmoney;
    }

    public void setP13_zfmoney(String p13_zfmoney) {
        this.p13_zfmoney = p13_zfmoney;
    }
